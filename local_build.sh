...
GODOT_PATH="/Users/carlosmichael/Library/Application Support/Godot/app_userdata/Godot Version Manager/versions/godot-4.2.2-spine.app/Contents/MacOS/Godot"
...
PACKAGE_NAME="island-fps_v${NEW_VERSION}"
